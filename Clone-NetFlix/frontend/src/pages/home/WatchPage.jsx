            ...
            <div className='bg-black h-screen text-white'>
                <div className='max-w-6xl mx-auto'>
                    ...
                    <div className='text-center mx-auto px-4 py-8 h-full mt-40'>
                        <h2 className='text-3xl font-bold sm:text-5xl text-balance'>Content not found 😥</h2>
                    </div>
                </div>
            </div>
        )
        ...
        <div className='mx-auto container px-4 py-8 h-full'>
            ...
            <div className='aspect-video mb-8 p-2 sm:px-10 md:px-32'>
                ...
                {trailers?.length === 0 && (
                    <h2 className='text-center text-xl mt-5'>
                        ...
                        <span className='text-red-600 font-bold'>{content?.title}</span>
                    </h2>
                )}
            </div>
            ...
            {similarContent.length > 0 && (
                <div className='mt-12 max-w-5xl mx-auto relative'>
                    ...
                    <div className='flex overflow-x-scroll scrollbar-hide gap-4 pb-4 ground' ref={sildeRef}>
                        {similarContent.map((content) => {
                           ...
                           return (
                            ...
                            >
                                <img src={SMALL_IMG_BASE_URL + content?.poster_path} alt={content.title}
