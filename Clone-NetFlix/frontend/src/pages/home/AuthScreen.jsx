  ...
  return (
    <div className='hero-bg relative'>
      ...
      <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
          ...
          <Link to={'/login'} className='text-white bg-red-600 px-2 py-1 rounded'>Sign In</Link>
      </header>

      {/*Hero section*/}
      <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
        <h1 className='text-4xl font-bold md:text-6xl mb-4'>Unlimited movies, TV shows, and more.</h1>
        <p className='text-lg mb-4'>Watch anywhere. Cancel anytime.</p>
        <p className='mb-4'>Ready to watch? Enter your email to create or restart your membership.</p>

        <form className='flex-col flex md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
            <input type='email'
            ...
            <button className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>Get Started
                <ChevronRight className='sizw-8 md:size-10' />
            </button>
        </form>
      </div>
          ...
          <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
            ...
            <div className='flex-1'>
              <div className='relative'>
                ...
                <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 h-24 lg:w-1/2 border border-slate-500 rounded-md px-2'>
