  ...
  if(!trendingContent) {
    return (
      <div className='h-screen text-white relative'>
        <Navbar />
        <div  
          className='absolute top-0 left-0 w-full h-full bg-black/70 items-center justify-center -z-50 shimmer'
        />
      </div>
    )
  }
  ...
  return (
    <>
      <div className='relative h-screen text-white'>
        ...
        <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-6 md:px-16 lg:px-32'>
